...
# Hint 2: If you are using a loop to compare the binary string characters, 
# consider that one may be longer than the other, and you will have to account for that:
